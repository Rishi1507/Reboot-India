...
export async function sendEmail({ to, subject, html, bookingId }: EmailPayload) {
...
export function buildAdvanceBookingEmail(payload: {
  customerName: string;
  trekkingId: string;
  trekTitle: string;
  startDate: string;
...
export function buildPaymentReminderEmail(payload: {
  customerName: string;
  trekTitle: string;
  startDate: string;
  amountDue: number;
...
export function buildBatchMessageEmail(payload: {
  customerName: string;
  subject: string;
  message: string;
}) {
...
export function buildCouponShareEmail(payload: {
  couponCode: string;
  discountText: string;
  validTo?: string;
  terms?: string[];
...
export function buildAdminOtpEmail(payload: { otp: string; expiresMinutes: number }) {
  return `
  <div style="font-family:Arial,sans-serif;background:#f5f5f5;padding:24px;">
...
export function buildBookingCancellationEmail(payload: {
  customerName: string;
  trekkingId: string;
  trekTitle: string;
  startDate: string;
